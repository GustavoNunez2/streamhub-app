  ...
  return (
    ...
    >
      <div className="relative aspect-[2/3] rounded-2xl overflow-hidden bg-surface border border-white/5 shadow-xl transition-all group-hover:border-white/20 group-hover:shadow-brand/20">
        <img
          // 1. Si item.poster está vacío (""), usamos una imagen de fondo por defecto
          src={item.poster || 'https://images.unsplash.com/photo-1594908900066-3f47337549d8?q=80&w=2070&auto=format&fit=crop'}
          alt={item.title}
          className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
          onError={(e) => {
            // 2. Si el link no está vacío pero la imagen está caída, también la reemplazamos
            e.currentTarget.onerror = null;
            e.currentTarget.src = 'https://images.unsplash.com/photo-1594908900066-3f47337549d8?q=80&w=2070&auto=format&fit=crop';
          }}
        />
